...
export const siteConfig = defineSiteConfig({
  ...
  // 已存在的 /zh/ 示例页仍可直接访问，便于以后启用或测试。改为 true 即可重新开启。
  multilingual: false,
  ...
  locales: {
    ...
    'en-US': {
      ...
      // 如需将英文首页改到 /en/blog/，应同时保留 path: '/' 作为语言路径前缀。
      home: '/',
      homeText: 'Home',
      postsText: 'Blog',
      ...
      navbar: [
        ...
        },
        {
          ...
          icon: 'more-circle',
          items: [
            { label: 'Categories', href: '/blog/categories/', icon: '/img/logo.svg' },
            { label: 'Tags', href: '/blog/tags/', icon: { svg: '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M3 4h8l10 10-7 7L4 11V4Zm4 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z"/></svg>' } },
            { label: 'Archives', href: '/blog/archives/', icon: 'archive' },
            { label: 'About', href: '/about/', icon: 'verified' },
          ],
        },
      ],
    },
