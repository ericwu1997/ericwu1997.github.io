...
permalink: /docs/guide/getting-started/
translationOf: /zh/docs/guide/getting-started/
type: doc
group: Guide
order: 5
badge: Start
...
Keep every other default for now. See [site configuration](/docs/guide/configuration/) for navigation, search, pagination, appearance, comments, and enhanced Markdown.
...
A successful run creates `dist/`. Use the provider configuration selected during creation or publish `dist/` with any static host; see [deployment](/docs/guide/deployment/).
...
Continue with [content features](/docs/guide/content/). Developers who need deeper customization can read [public API and styling](/docs/guide/api/).
