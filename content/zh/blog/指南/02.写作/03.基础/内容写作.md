---
title: 内容与双语路由指南
description: 介绍文章目录、固定链接、分类标签和中英文关联方式。
permalink: /zh/blog/content-guide/
...
文件 `content/zh/blog/指南/02.写作/03.基础/内容写作.md` 会依次归入“指南 / 写作 / 基础”分类；数字前缀只控制排序，不会显示在页面上。分类页、标签页和归档页都在构建时自动生成。
...
英文内容放在 `content/blog/` 下，并使用 `translationOf` 指向中文路由：
