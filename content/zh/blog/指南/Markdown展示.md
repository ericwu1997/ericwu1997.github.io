...
permalink: /zh/blog/markdown-showcase/
...
<CardGrid :cols="{ sm: 1, md: 2, lg: 3 }">
  <LinkCard title="响应式一" href="/zh/docs/" />
  <LinkCard title="响应式二" href="/zh/docs/guide/configuration/" />
  <LinkCard title="响应式三" href="/zh/docs/guide/content/" />
</CardGrid>
...
@[qrcode title="文档首页" width="96"](/zh/docs/index.md)
:::
