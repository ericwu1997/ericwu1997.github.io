...
permalink: /zh/docs/guide/content/
type: doc
group: 指南
order: 20
...
Wiki 链接、内容嵌入、Callout 与 `%%` 注释默认开启，并可在 `site.config.mjs` 的 `markdown.obsidian` 中分别关闭。[[zh/docs/guide/configuration|查看站点配置]]。
...
![[zh/docs/guide/configuration#页面过渡]]
