...
lang: en-US
translationOf: /zh/blog/markdown-showcase/
...
<CardGrid :cols="{ sm: 1, md: 2, lg: 3 }">
  <LinkCard title="Responsive one" href="/docs/" />
  <LinkCard title="Responsive two" href="/docs/guide/configuration/" />
  <LinkCard title="Responsive three" href="/docs/guide/content/" />
</CardGrid>
...
@[qrcode title="Documentation" width="96"](/docs/index.md)
:::
